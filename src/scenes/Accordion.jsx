...
const Accordion = () => {
  ...
  return (
      <div className='w-full pt-8 pb-24'>
          <div className=''>
          <h1 className=' text-center text-6xl text-white'>Frequently Asked Questions</h1>
          </div>
          <div className='py-12 flex-col justify-center items-center flex gap-1'>
              <button className=' flex justify-between bg-[#333] text-white items-center w-[50rem] h-[5rem] relative' onClick={() => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              ...
              {isAccord1 ? (
                <div className='bg-[#333] w-[50rem] mt-[2px] transition duration-500'>
              ...
              <button className=' flex justify-between bg-[#333] text-white items-center w-[50rem] h-[5rem]' onClick={() => {
  ...
  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
              ...
              {isAccord2 ? (
                <div className='bg-[#333] w-[50rem] mt-[2px] transition'>
 ...
 <div className='mt-5 flex text-start'>
              ...
              <button className='bg-[#e50914] px-7 py-3 flex justify-center items-center text-3xl gap-1 text-white'><h5>Get Started</h5><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
